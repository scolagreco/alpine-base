...
La versione 3.23.4 di Alpine Linux [(Repository)](https://github.com/scolagreco/docker-alpine/tree/v3.23.4).

## Versions

- `latest` [(Dockerfile)](https://github.com/scolagreco/alpine-base/blob/master/Dockerfile)
- [`v3.23.4`](https://github.com/scolagreco/alpine-base/releases/tag/v3.23.4)
